...
import { Calendar, Users, Brain, Zap, BookOpen, Newspaper, Settings } from "lucide-react"
    ...
    <div className="min-h-screen bg-soot-glue">
      ...
      <nav className="bg-soot-glue border-b border-gray-700 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <MobileNav currentPath="/documents" />
          </div>
        </div>
      </nav>

      {/* Hero Section */}
      <section className="bg-buttercup py-12 sm:py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <FileText className="h-16 w-16 text-soot-glue mx-auto mb-6" />
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-soot-glue mb-6">LNU AI Society Documents</h1>
          <p className="text-lg sm:text-xl text-soot-glue leading-relaxed">
            Welcome to the LNU AI Society Document Archive
          </p>
        </div>
      </section>
      ...
      <section className="py-12 sm:py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <Card className="bg-gray-900 border-2 border-gray-700 mb-8">
            <CardContent className="p-8">
              <p className="text-gray-300 text-lg leading-relaxed mb-6">
                This platform is the official repository for essential documents related to the governance, legal
                obligations, and operational transparency of the LNU AI Society. It includes yearly meeting protocols,
                statutory documents, and other official records crucial for maintaining the integrity and accountability
                of our organization.
              </p>
              <p className="text-gray-300 text-lg leading-relaxed mb-6">
                Our archive is designed to ensure members and stakeholders have easy access to pertinent information,
                reinforcing our commitment to transparency and legal compliance.
              </p>
              <p className="text-gray-300 text-lg leading-relaxed">
                For inquiries or further assistance, please contact{" "}
                <a href="mailto:contact@lnuaisociety.com" className="text-buttercup hover:underline">
                  contact@lnuais.com
                </a>
                .
              </p>
